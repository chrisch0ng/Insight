# Project Insight - Calculating Pearson Correlation between Sentiment and Price action of a stock, and showing the sentiment change
# in scraped article titles with a time delay of a week. Using AutoRegressive Integrated Moving Average to predict next week's
# price action in relation to this week's sentiment changes
...
# ALL THE FUNCTIONS NEEDED TO CLASSIFY SENTIMENT AND CALCULATE CURVES 
...
def get_stock_data(ticker, start_date, end_date):
    stock_data = yf.download(ticker, start=start_date, end=end_date, multi_level_index=False) # Pull ticker data
